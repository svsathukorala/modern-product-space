    ...
    <div className="min-h-screen bg-gradient-to-b from-space-dark via-purple-900/20 to-space-light text-white overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center p-4">
        ...
        <div className="flex gap-4 mb-12">
          <Button 
            variant="default"
            className="bg-purple-600 hover:bg-purple-700 text-white px-8 py-6 text-lg rounded-full transition-all duration-300 hover:scale-105 hover:shadow-[0_0_15px_rgba(168,85,247,0.5)]"
          >
            Get Started
          </Button>
          <Button 
            variant="outline"
            className="border-purple-500 text-purple-400 hover:bg-purple-500/10 px-8 py-6 text-lg rounded-full transition-all duration-300 hover:shadow-[0_0_15px_rgba(168,85,247,0.3)]"
          >
            Documentation
          </Button>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <div className="p-6 rounded-xl bg-purple-900/20 backdrop-blur-sm hover:bg-purple-900/30 transition-all duration-300 transform hover:scale-105 hover:shadow-[0_0_15px_rgba(168,85,247,0.3)]">
