  ...
  return (
    <div className="min-h-screen bg-apple-white dark:bg-dark-background text-apple-dark dark:text-white transition-colors duration-300">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center p-4 overflow-hidden">
        ...
        <p className="text-xl text-apple-silver dark:text-gray-400 mb-8 text-center max-w-2xl animate-fade-in delay-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <div className="p-6 rounded-2xl bg-apple-gray/50 dark:bg-dark-muted hover:bg-apple-gray dark:hover:bg-dark-muted/80 transition-all duration-300">
                ...
                <p className="text-apple-silver dark:text-gray-400">• 99.9% Uptime<br/>• Global CDN<br/>• Sub-100ms Latency</p>
              </div>
              <div className="p-6 rounded-2xl bg-apple-gray/50 dark:bg-dark-muted hover:bg-apple-gray dark:hover:bg-dark-muted/80 transition-all duration-300">
                <h3 className="font-semibold mb-2 text-apple-blue">Security</h3>
                <p className="text-apple-silver dark:text-gray-400">• End-to-end Encryption<br/>• SOC2 Compliant<br/>• Regular Security Audits</p>
              </div>
            </div>
            <div className="space-y-4">
              <div className="p-6 rounded-2xl bg-apple-gray/50 dark:bg-dark-muted hover:bg-apple-gray dark:hover:bg-dark-muted/80 transition-all duration-300">
                <h3 className="font-semibold mb-2 text-apple-blue">Scalability</h3>
                <p className="text-apple-silver dark:text-gray-400">• Auto-scaling<br/>• Load Balancing<br/>• Distributed Systems</p>
              </div>
              <div className="p-6 rounded-2xl bg-apple-gray/50 dark:bg-dark-muted hover:bg-apple-gray dark:hover:bg-dark-muted/80 transition-all duration-300">
                <h3 className="font-semibold mb-2 text-apple-blue">Developer Tools</h3>
                <p className="text-apple-silver dark:text-gray-400">• Comprehensive SDK<br/>• CLI Tools<br/>• Extensive Documentation</p>
              </div>
            </div>
          </div>
        </div>
